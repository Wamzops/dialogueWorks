...
const SimpleNavigation = () => {
  ...
  return (
    <section className="overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          <div className="relative flex items-center justify-between">
            <Link className="inline-block" href="/">
              <Image
                className="h-25"
                src="/images/logo_light_theme.svg"
                alt=""
                width={120}
                height={32}
              />
            ...
            <ul className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 hidden md:flex">
              <li className="mr-4 lg:mr-8">
                <Link
                  className="inline-block text-sky-900 hover:text-sky-700 font-medium"
                  href="/about"
                >
                  About us
                </Link>
            ...
            <div className="flex items-center justify-end">
              <div className="hidden md:block">
                <div className="hidden md:block">
                  <Link
                    className="inline-flex py-2.5 px-4 mr-3 lg:mr-4 items-center justify-center text-sm font-medium text-sky-900 hover:text-white border border-sky-900 hover:bg-sky-900 rounded-full transition duration-200"
                    href="/login"
                  >
                    Login
                  </Link>
                  <Link
                    className="inline-flex py-2.5 px-4 items-center justify-center text-sm font-medium text-white border border-sky-900 hover:border-black bg-sky-900 hover:bg-black rounded-full transition duration-200"
                    href="/contact"
                  >
                    Get in touch
                  </Link>
              ...
              <button
                className="md:hidden text-sky-900 hover:text-sky-800"
      ...
      <div
        className={`${mobileNavOpen ? "block" : "hidden"} fixed top-0 left-0 bottom-0 w-full xs:w-5/6 xs:max-w-md z-50`}
      >
        <div
        ...
        <nav className="relative flex flex-col py-7 px-10 w-full h-full bg-white overflow-y-auto">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <Link
                className="inline-flex py-2.5 px-4 items-center justify-center text-sm font-medium text-sky-900 hover:text-white border border-sky-900 hover:bg-sky-900 rounded-full transition duration-200"
                href="/login"
              >
                Login
              </Link>
          ...
          <div className="flex items-center justify-between">
            <Link
              className="inline-flex items-center text-lg font-medium text-sky-900"
              href="/contact"
            >
              <span>
                <svg
