...
const AuthForm = ({
  ...
  return (
    <section
      className={`relative pt-52 xs:pt-40 pb-16 md:pb-24 lg:pb-52 bg-orange-50 overflow-hidden ${className}`}
    >
      {/* Alternative Action */}
      <p className="absolute top-0 right-0 mt-32 xs:mt-12 mr-5">
        ...
        <Link
          ...
          className="inline-block font-medium underline hover:text-sky-600 ml-1"
        >
          {alternativeLinkText}
        </Link>
      </p>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <input
                  ...
                  required
                  aria-describedby={
                    errors.password ? `${type}-password-error` : undefined
                  }
                />
                <button
                  type="button"
            ...
            {isLogin && (
              <div className="text-right mb-10">
                <a
                  className="inline-block text-sm underline font-medium hover:text-sky-600 transition-colors duration-200"
                  href="#"
                >
                  Forgot password?
                </a>
            ...
            <Button
              ...
              variant="primary"
              size="large"
              className="w-full mb-4 bg-sky-900 hover:bg-sky-500 border-sky-900 hover:border-sky-500 text-white hover:text-sky-900"
            >
              {submitText}
            </Button>
            ...
            {showGoogleAuth && (
              <>
                ...
                <Button
                  variant="outline"
                  size="large"
                  className="w-full border-sky-900 hover:bg-black hover:border-black text-black hover:text-white"
                  onClick={(e) => {
                    e.preventDefault();
