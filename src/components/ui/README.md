...
<SocialIcons
  ...
  iconClassName="inline-block mx-2 text-white hover:text-sky-500"
/>
...
// Menu icon
<MenuIcon className="text-white hover:text-sky-500" />
...
- **Primary colors**: sky-900, sky-500
...
- **Focus states**: ring-2 ring-sky-500 for accessibility
