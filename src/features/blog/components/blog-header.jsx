...
const BlogHeader = ({ onShowAll }) => {
  ...
  <h1 className="font-heading text-5xl sm:text-6xl">Blog</h1>
      ...
      <div className="w-full sm:w-1/2 px-4 sm:text-right">
        <button
          className={`inline-flex py-4 px-6 items-center justify-center text-lg font-medium text-black hover:text-white border border-sky-900 hover:bg-sky-900 rounded-full transition duration-300 ${showAllContent ? "hidden" : ""}`}
