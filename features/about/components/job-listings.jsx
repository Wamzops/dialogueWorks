        ...
        <div className="w-full lg:w-1/2 px-4">
          <div className="sm:flex">
            <div className="relative inline-block w-full max-w-xs mb-4 sm:mb-0 sm:mr-4 bg-white rounded-full">
              ...
              <select
                className="w-full px-4 py-3 font-medium border rounded-full appearance-none cursor-pointer outline-none ring-offset-0 focus:ring-2 focus:ring-sky-500 bg-transparent relative"
              ...
              <li key={job.id}>
                <article className="py-6 px-8 mb-4 bg-white rounded-2xl shadow-md">
                  <div className="flex flex-col sm:flex-row md:justify-between items-start">
                    ...
                    <a
                      className="inline-flex ml-auto group items-center text-lg text-black hover:text-sky-600 transition duration-100"
                      href="#"
                    >
