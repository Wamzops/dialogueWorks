                ...
                <div className="items-center gap-x-12 lg:flex">
                    ...
                    <div className="max-w-xl mt-6 md:mt-0 lg:max-w-2xl">
                        <h2 className="text-gray-800 text-3xl font-semibold sm:text-4xl">
                            Create Lasting Peace Through Inclusive Dialogue and Action.
                        </h2>
                        <p className="mt-3 text-gray-600">
                            We are a non-profit organization dedicated to fostering peace, security, and sustainable development through community-driven initiatives, evidence-based research, and collaborative partnerships.
                        </p>
                        <NavLink
                            href="/get-started"
