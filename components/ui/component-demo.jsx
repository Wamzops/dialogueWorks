    ...
    <div className="max-w-4xl mx-auto p-8 space-y-12">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <SocialIcons
              ...
              iconClassName="inline-block mx-2 text-gray-600 hover:text-white hover:bg-sky-900 p-2 rounded"
            />
          </div>
      ...
      <section>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              <ArrowIcon direction="left" color="sky" />
              <span>Left Arrow</span>
            </div>

            <div className="flex items-center gap-2">
              <ArrowIcon direction="right" className="text-sky-500" />
              <span>Right Arrow</span>
            </div>

            <div className="flex items-center gap-2">
              <ArrowIcon direction="up" color="teal" />
              <span>Up Arrow</span>
            </div>
      ...
      <section>
        ...
        <div className="border rounded-lg p-4 bg-sky-900">
          ...
          {showMobileNav && (
            <div className="mt-4 pt-4 border-t border-white/20">
              <nav className="space-y-2">
                <a
                  href="#"
                  className="block text-white hover:text-sky-500 py-2"
                >
                  Home
                </a>
                <a
