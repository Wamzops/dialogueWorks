...
const Button = ({
  ...
  const variantClasses = {
    primary:
      "text-sky-900 border border-sky-500 hover:border-white bg-sky-500 hover:bg-white focus:ring-sky-500",
    secondary:
      "text-white hover:text-sky-900 border border-white hover:bg-white focus:ring-white",
    outline:
      "text-sky-900 hover:text-white border border-sky-900 hover:bg-sky-900 focus:ring-sky-900",
    link: "text-gray-700 hover:text-gray-900",
    register: "bg-teal-600 text-white hover:bg-teal-700 focus:ring-teal-500",
  };
