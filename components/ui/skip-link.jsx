...
const SkipLink = ({
  ...
  <a
    href={href}
    className={`sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 bg-teal-600 text-white px-4 py-2 rounded transition-all duration-200 font-medium ${className}`}
    style={{ zIndex: 9999 }}
  >
    {children}
  </a>
